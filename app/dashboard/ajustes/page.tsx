...
const AjustesPage = () => {
  ...
  return (
    <div className="w-full mx-auto rounded-non3e md:rounded-2xl p-4 md:p-8 shadow-input  bg-zinc-800">
      <h2 className="font-bold text-xl  text-white flex justify-center">
        Editar y Actualizar
      </h2>
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
          <button
            className="bg-gradient-to-br hover:text-c1 relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
            type="submit"
          >
            Enviar
            <BottomGradient />
